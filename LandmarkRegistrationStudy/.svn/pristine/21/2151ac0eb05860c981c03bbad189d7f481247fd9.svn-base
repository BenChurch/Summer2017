...
class StandardizeLandmarks(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.helpText = "This module can be used to center and normalize the landmarks, and extrapolate them to completion (for omission repair, see PreProcessLandmarks)"
