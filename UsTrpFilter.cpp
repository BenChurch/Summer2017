...
int main(int argc, char **argv)
{
  ...
  vtkXMLDataElement* boneFilterConfig = configRootElement->FindNestedElementWithName("vtkPlusTransverseProcessEnhancer");
  if (boneFilterConfig == NULL)
  {
    LOG_ERROR("Cannot find vtkPlusTransverseProcessEnhancer element in XML tree!");
    return PLUS_FAIL;
  }
